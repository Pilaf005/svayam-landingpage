...
export const ProcessRoadmap: React.FC = () => {
  ...
  return (
    <section id="process" className="py-20 bg-[#f8f9fa] border-b border-[#e5e7eb]">
      <div className="max-w-[1300px] mx-auto px-4 sm:px-6 lg:px-8">

        {/* Section Header */}
        <div className="text-center max-w-4xl mx-auto mb-12">
          <div className="pill-token mb-4 inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white border border-[#e5e7eb] text-[12px] font-semibold text-[#212529]">
        ...
        <div
          ...
          className="flex gap-5 overflow-x-auto no-scrollbar scroll-smooth snap-x snap-mandatory pb-4 pt-1 px-1"
        ...
        >
          {PROCESS_STEPS.map((step) => {
            ...
            return (
              <div
                key={step.number}
                className="card-token p-6 flex flex-col justify-between shrink-0 snap-start w-[300px] sm:w-[340px] lg:w-[calc((100%-2.5rem)/3)] hover:border-[#0067b8] hover:-translate-y-0.5 transition-all duration-200"
              >
                <div>
                ...
                <div className="pt-4 border-t border-[#e5e7eb] space-y-2">
                  <div className="text-[11px] font-bold text-[#414141] uppercase tracking-wider mb-2">
